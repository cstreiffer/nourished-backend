...
exports.invokeRolesPolicies = function() {
  acl.allow([{
    roles: ['admin'],
    allows: [{
      resources: '/api/hospitals',
      permissions: []
    }, {
      resources: '/api/hospitals/:hospitalId',
      permissions: []
    }]
  }, {
    roles: ['restaurant'],
...
exports.isAllowed = function(req, res, next) {
  ...
  // If hospital is being processed and the current user created it then allow any manipulation
  // if (req.hospital && req.user && req.hospital.userId === req.user.id) {
  //   return next();
  // }
