...
var 
  twilioMessages = [
    ...
    {id: uuid(), type: 'OUTGOING', subtype: 'DAILY_ORDER', messageBody: 'Your meal from %s has been delivered! You can pick-up your order now at the %s. If you have any issues, please contact us at %s. Please be advised that due to food safety concerns, your meal should be consumed or refrigerated by 3 hours after delivery! Enjoy! 🍴'},
