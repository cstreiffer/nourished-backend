...
var 
  twilioMessages = [
    ...
    {id: uuid(), type: 'STRIPE_RESPONSE', subtype: 'STRIPE_RESPONSE_MESSAGE', keyword: 'FAILED', messageBody: 'Oops, there was an error with your credit card payment for your order from %s. If you\'d still like to receive this order, please try to place the order again.'},
    {id: uuid(), type: 'STRIPE_RESPONSE', subtype: 'STRIPE_RESPONSE_MESSAGE', keyword: 'CANCELLED', messageBody: 'Your refund for your order from %s is on its way! It is being processed and should appear on account in 3-5 business days. Please check your email for a complete receipt.'},
