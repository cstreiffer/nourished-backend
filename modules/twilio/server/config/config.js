...
var 
  twilioMessages = [
    ...
    {id: uuid(), type: 'INCOMING', subtype: 'STATIC_FUNCTION', keyword: 'DEFAULT', messageBody: 'Sorry we did recognize that message! Text "ORDER" at any time to place an order and get Nourished! Or "STOP" to opt-out of text notifications!'},
